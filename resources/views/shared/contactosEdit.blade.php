    ...
    <div id="contactos"  class="p-2  border">
        <!--se copiara lo  siguiente presionando el boton agregar-->
            ...
            <div class=" row "> 
                    ...
                    <div class="form-group col-md-3">
                        <input type="text" name="contacto-telefono[]" value='{{$contactos[$i]->telefono}}' class="form-control"  placeholder="Ingrese telefono" />
                    </div>
        
                    <div class="form-group col-md-3">
                        <input type="text" name="contacto-email[]" value='{{$contactos[$i]->email}}' class="form-control" placeholder="Ingrese correo electrónico"  />
                    </div>
